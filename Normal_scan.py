...
if __name__ == "__main__":
    ...
    # Step 3: Run SQL injection tests on all live URLs
    if not live_urls:
        print(Fore.RED + "\nNo live subdomains found. Exiting.")
        exit(1)

    print(Fore.YELLOW + "\nLive URLs for SQL injection testing:")
    for live_url in live_urls:
        print(Fore.GREEN + f" - {live_url}")

    sql_command = input(Fore.CYAN + "\nEnter additional SQLMap options (leave empty for default): ").strip()
